...
| [C15, paraderos, ID 3915](https://api.buscador-rutas.transmilenio.gov.co/api/v1/rutas/3915/C15/paraderos), [H15, ID 367](https://api.buscador-rutas.transmilenio.gov.co/api/v1/rutas/367/H15/), [H15, paraderos](https://api.buscador-rutas.transmilenio.gov.co/api/v1/rutas/367/H15/paraderos) | Contraste verificado aparte: 19 paradas por sentido. Evidencia en `data/research/c15_h15_20260910`. La C15 Chapinero Ciclovía ID 366 es zonal y queda excluida mediante `data/curated/services.json`. |
